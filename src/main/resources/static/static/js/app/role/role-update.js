$(document).ready(function() {
	...
	$("#authorization-card").on("click", "input[type='checkbox'][id$='-action-checkbox']", function () {
		...
		checkFeatureIfAllActionsAreChecked(featureCard);
	});

	// Initially select all the feature checkboxes, if all actions are checked
	$("#authorization-card .card").each(function(_, element) {
		let featureCard = $(element);
		checkFeatureIfAllActionsAreChecked(featureCard);
	});
	
	function checkFeatureIfAllActionsAreChecked(featureCard) {
